...
#define kUrl_VerifyUser @"http://2.server4puman.sinaapp.com/user/verif"
#define kUrl_VerifyPhoneWithCode @"http://2.server4puman.sinaapp.com/user/verify_phone"
#define kUrl_ResetPwd @"http://2.server4puman.sinaapp.com/user/reset_pwd"
#define kUrl_ChangePwd @"http://2.server4puman.sinaapp.com/user/change_pwd"
#define kUrl_ChangeMailOrPhone @"http://2.server4puman.sinaapp.com/user/change_account"
#define kUrl_ConnectUser @"http://2.server4puman.sinaapp.com/user/connect"
#define kUrl_SetDeviceToken @"http://2.server4puman.sinaapp.com/user/set_device_token"
//user/baby
...
//diary
#define kUrl_UpdateDiary @"http://2.server4puman.sinaapp.com/diary/update"
#define kUrl_UploadUserTask @"http://2.server4puman.sinaapp.com/diary/upload"
