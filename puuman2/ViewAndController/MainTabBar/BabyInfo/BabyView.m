...
- (void)initTitleInfoView
{
    ...
    info_name = [[UILabel alloc] initWithFrame:CGRectMake(256, 64, 144, 30)];
    ...
    info_age= [[UILabel alloc] initWithFrame:CGRectMake(405, 64, 110, 30)];
    ...
    if ([[[UserInfo sharedUserInfo] babyInfo] WhetherBirth]) {
        info_birthday = [[UILabel alloc] initWithFrame:CGRectMake(520, 64, 200, 30)];
