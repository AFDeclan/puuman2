...
- (void)initialization
{
    ...
    wareImgView = [[AFImageView alloc] initWithFrame:CGRectMake(16, 88, 248, 248)];
    [wareImgView setImage:[UIImage imageNamed:default_ware_image]];
    [self addSubview:wareImgView];
    wareName  = [[UILabel alloc] initWithFrame:CGRectMake(280, 88, 336, 78)];
    ...
    [self addSubview:wareName];
    UIImageView *icon_price = [[UIImageView alloc] initWithFrame:CGRectMake(280, 166, 10, 12)];
    [icon_price setImage:[UIImage imageNamed:@"icon_rmb_shop.png"]];
    [self addSubview:icon_price];
    priceLabel = [[UILabel alloc] initWithFrame:CGRectMake(296, 78, 0, 0)];
    [priceLabel setFont:PMFont1];
    ...
    UILabel *price_flag= [[UILabel alloc] initWithFrame:CGRectMake(ViewX(priceLabel)+ViewWidth(priceLabel) , ViewY(priceLabel), 0, 0)];
    [price_flag setFont:PMFont(32)];
    [price_flag setTextColor:PMColor1];
    [price_flag setBackgroundColor:[UIColor clearColor]];
    [price_flag setText:@"00"];
    [self addSubview:price_flag];
    ...
    [self addSubview:reduceCountBtn];
    
    
    changeCountLabel = [[UILabel alloc] initWithFrame:CGRectMake(85, 4, 30, 16)];
    ...
    [self addSubview:changeCountLabel];
    ...
    [shareBtn initWithTitle:@"+加入购物车" andButtonType:kBlueLeftDown];
    ...
    UILabel *arealabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 18, 40, 20)];
    [arealabel setBackgroundColor:[UIColor clearColor]];
    [arealabel setText:@"送货至"];
    [arealabel setTextColor:PMColor2];
    [arealabel setFont:PMFont4];
    [arealabel setTextAlignment:NSTextAlignmentCenter];
    [self addSubview:arealabel];
    
    UILabel *countLabel =[[UILabel alloc] initWithFrame:CGRectMake(40, 50, 30, 20)];
    [countLabel setBackgroundColor:[UIColor clearColor]];
    [countLabel setText:@"数量"];
    [countLabel setTextColor:PMColor2];
    [countLabel setFont:PMFont4];
...
- (CGFloat) tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        return ViewHeight(headView)+ViewHeight(titleView)+ViewHeight(middleView);
    } else {
        
        
        return ViewHeight(singleProductTableView)-ViewHeight(headView)-ViewHeight(titleView)-ViewHeight(middleView);
    }
