...
- (void)cancel
{
    ...
    [MobClick event:umeng_event_click label:@"Close_SinaWeiboAuthorizeView"];
    [self hide];
...
- (void)webViewDidFinishLoad:(UIWebView *)aWebView
{
    ...
    CGRect centreFrame = CGRectMake((contentSize.width-scrollSize.width)/2, 0, scrollSize.width, scrollSize.height);
    [scrollView scrollRectToVisible:centreFrame animated:NO];
}
