...
NSString *const MJRefreshFooterRefreshing = @"扑满正在努力加载数据...";

NSString *const MJRefreshHeaderPullToRefresh = @"下拉拉可以刷新";
NSString *const MJRefreshHeaderReleaseToRefresh = @"松开立即刷新";
NSString *const MJRefreshHeaderRefreshing = @"扑满正在努力刷新...";
